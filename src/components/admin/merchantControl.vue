                ...
                <CAccordion style="width: 700px;">
                    <CAccordionItem v-for="merchant in merchants" :key="merchant.merchantCategory">
                        ...
                        <CAccordionBody>
                            ...
                            <label>Enable:&emsp;  </label><input v-if="merchant.enable == 1" :id="merchant.merchantCategory + 'enable'" value="True" readonly/><input v-else :id="merchant.merchantCategory + 'enable'" value="False" readonly/>
                            <div style="margin-left: 62%;">
                                ...
                                <CButton v-if="merchant.enable == 1" @click="remove(merchant.merchantCategory)" color="danger" shape="rounded-pill">Disable</CButton>
                                <CButton v-else @click="remove(merchant.merchantCategory)" color="primary" shape="rounded-pill">Enable</CButton>
                            </div>
                        </CAccordionBody>
                    </CAccordionItem>
                </CAccordion>
