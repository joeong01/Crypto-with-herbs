    ...
    <div class="page" style="width:80%;">
      ...
      <nav class="page__menu page__custom-settings menu">
        <ul class="menu__list r-list">
          ...
          <!-- <li class="menu__group"><a href="/admin" target="_blank" class="menu__link r-link text-underlined">Admin part</a></li> -->
        </ul>
      </nav>
    </div>
    <div class="page" style="width:20%;">
      <nav class="page_menu page__custom-settings menu">
        <ul class="menu__list r-list">
          ...
          <li class="menu__group"><a href="/LogIn" class="menu__link r-link text-underlined">Sign In</a></li>
        </ul>
      </nav>
    </div>
  </div>
